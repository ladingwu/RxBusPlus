...
public interface Finder {
    ...
    Map<EventType, Set<SubscriberEvent>> findAllStrickSubscribers(Object listener);
    ...
    Finder ANNOTATED = new Finder() {
        ...
        @Override
        public Map<EventType, Set<SubscriberEvent>> findAllStrickSubscribers(Object listener) {
            return AnnotatedFinder.findAllStrickSubscribers(listener);
        }
    };
}
